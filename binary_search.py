...
class BinarySearchTree:
    ...
    def __search__(self,value,current_node):
        ...
        if value == current_node.value:
            ...
            self.__search__(value,current_node.left_child)
        elif value > current_node.value and current_node.right_child is not None:
            print("Calling __search__ with right child")            
            self.__search__(value,current_node.right_child)
        else:
            print("__search__: I should not be here")
        print("__search__: Returning False")
        return False
